...
See example of [cookbook with streaming](https://github.com/agno-agi/agno/blob/main/cookbook/workflows/_06_advanced_basics/_04_shared_session_state/access_session_state_in_custom_function_step_stream.py).