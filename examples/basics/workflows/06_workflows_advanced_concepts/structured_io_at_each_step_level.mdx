...
- [Structured IO at each Step level Team](https://github.com/agno-agi/agno/blob/main/cookbook/workflows/_06_advanced_basics/_01_structured_io_at_each_level/structured_io_at_each_level_team_stream.py)
- [Structured IO at each Step level Custom Function-1](https://github.com/agno-agi/agno/blob/main/cookbook/workflows/_06_advanced_basics/_01_structured_io_at_each_level/structured_io_at_each_level_function_1.py)
- [Structured IO at each Step level Custom Function-2](https://github.com/agno-agi/agno/blob/main/cookbook/workflows/_06_advanced_basics/_01_structured_io_at_each_level/structured_io_at_each_level_function_2.py)