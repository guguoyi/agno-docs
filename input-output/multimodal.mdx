...
Agents can process images, audio, video, and files as input, and generate images and audio as output. This section introduction Multimodal I/O, checkout the [full guide](/features/multimodal/overview) for more details.
...
For detailed guides and examples, see the [Multimodal documentation](/features/multimodal/overview):

- [Image input](/features/multimodal/images/image-input)
- [Audio input](/features/multimodal/audio/audio_input)
- [Video input](/features/multimodal/video/video_input)
- [Image generation](/features/multimodal/images/image-output)
- [Audio generation](/features/multimodal/audio/audio_output)