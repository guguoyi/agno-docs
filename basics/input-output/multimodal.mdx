...
- [Audio input](/features/multimodal/audio/audio-input)
- [Video input](/features/multimodal/video/video-input)
- [Image generation](/features/multimodal/images/image-output)
- [Audio generation](/features/multimodal/audio/audio-output)