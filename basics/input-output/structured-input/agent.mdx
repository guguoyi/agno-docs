...
- [Team Structured Input](/basics/input-output/structured-input/team): Configure structured input for teams
- [Structured Output](/basics/input-output/structured-output/agent): Get validated output from agents