...
- [AWS Bedrock](/basics/knowledge/embedder/aws_bedrock)
- [Azure OpenAI](/basics/knowledge/embedder/azure_openai)
...
- [Qdrant FastEmbed](/basics/knowledge/embedder/qdrant_fastembed)
