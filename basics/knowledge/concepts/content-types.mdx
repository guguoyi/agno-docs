...
For more information about the different readers and their capabilities checkout the [Readers](/basics/knowledge/concepts/readers/overview) page.
...
<CardGroup cols={3}>
  ...
  <Card title="Readers" icon="book-open" href="/basics/knowledge/concepts/readers/overview">
    Explore content parsing and ingestion options in detail
  </Card>
  <Card title="Chunking Strategies" icon="scissors" href="/basics/knowledge/concepts/chunking/overview">
