...
Learn more about [choosing chunking strategies](/basics/knowledge/concepts/chunking/overview).
...
<CardGroup cols={3}>
  ...
  <Card title="Embedders" icon="vector-square" href="/basics/knowledge/concepts/embedder/overview">
    Choose the right embedder for your use case
  </Card>
  <Card title="Hybrid Search" icon="magnifying-glass" href="/basics/knowledge/concepts/search-and-retrieval/hybrid-search">
    Combine vector and keyword search for better results
  </Card>
</CardGroup>
