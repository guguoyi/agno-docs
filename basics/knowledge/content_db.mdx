...
- **[PostgreSQL](/basics/storage/postgres)** - Recommended for production
- **[SQLite](/basics/storage/sqlite)** - Great for development and single-user applications  
- **[MySQL](/basics/storage/mysql)** - Enterprise-ready relational database
- **[MongoDB](/basics/storage/mongodb)** - Document-based NoSQL option
- **[Redis](/basics/storage/redis)** - In-memory option for high performance
- **[In-Memory](/basics/storage/in-memory)** - Temporary storage for testing
- **Cloud Options** - [DynamoDB](/basics/storage/dynamodb), [Firestore](/basics/storage/firestore), [GCS](/basics/storage/gcs)
