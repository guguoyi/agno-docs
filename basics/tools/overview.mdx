...
See the [image input example](/examples/basics/agent/multimodal/image_input_for_tool) and [file input example](/examples/basics/agent/multimodal/file_input_for_tool) for an advanced example using media.
