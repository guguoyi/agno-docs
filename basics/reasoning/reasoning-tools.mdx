...
See the [Reasoning Tools](/basics/tools/reasoning_tools/reasoning-tools) documentation for more details.
...
See the [Knowledge Tools](/basics/tools/reasoning_tools/knowledge-tools) documentation for more details.
...
- View [Agents with Reasoning Tools Examples](/examples/basics/reasoning/tools)
- View [Agents with Reasoning Tools Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/reasoning/tools)
- View [Teams with Reasoning Tools Examples](/examples/basics/reasoning/tools/reasoning-finance-team)
