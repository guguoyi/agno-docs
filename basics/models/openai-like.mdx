...
`OpenAILike` extends the OpenAI-compatible interface and supports all parameters from [OpenAIChat](/basics/models/openai). Simply change the `base_url` and `api_key` to point to your preferred OpenAI-compatible service.
