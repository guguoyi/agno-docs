...
this [example](/examples/basics/agent/async/basic).
...
<Tip>
    ...
    See the [Input & Output](/basics/input_output/overview) docs for more information, and to see how to use structured input and output with agents.
...
For asynchronous streaming, see this [example](/examples/basics/agent/async/streaming).
...
For more information see the [Multimodal Agents](/basics/multimodal) documentation.
...
See more details in the [Human-in-the-Loop](/basics/hitl) documentation.
