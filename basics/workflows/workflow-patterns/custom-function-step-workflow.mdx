...
For a detailed example see [Class-based Executor](/examples/basics/workflows/01-basic-workflows/class_based_executor).
...
- [Step with a Custom Function](/examples/basics/workflows/01-basic-workflows/step_with_function)
- [Step with a Custom Function with Streaming on AgentOS](/examples/basics/workflows/01-basic-workflows/step_with_function_streaming_agentos)
- [Parallel and custom function step streaming on AgentOS](/examples/basics/workflows/04-workflows-parallel-execution/parallel_and_custom_function_step_streaming_agentos)