...
- [Sequence of Functions and Agents](/examples/basics/workflows/01-basic-workflows/sequence_of_functions_and_agents) - Complete workflow with functions and agents
