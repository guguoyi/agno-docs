...
7. **Response is processed** and parsed into an [`output_schema`](/basics/input_output/team#structured-output) if provided.
...
See the [Input & Output](/basics/input_output/overview) docs for more information, and to see how to use structured input and output with teams.
