...
<Tip>
  Examples of ways to do Audio to Text (Transcribe) are:
   - [Using Gemini model](/examples/basics/multimodal/audio-to-text)
   - [Using OpenAI Model](/examples/basics/agent/multimodal/audio_input_output)
   - [Using `OpenAI Tool`](/basics/tools/toolkits/models/openai#1-transcribing-audio)
   - [Using `Groq Tool`](/basics/tools/toolkits/models/groq#1-transcribing-audio)
</Tip>
...
- View [Multimodal Examples](/examples/basics/agent/multimodal/audio_to_text)
- View [Team Examples](/examples/basics/teams/multimodal/audio_to_text)
- View [OpenAI Toolkit](/basics/tools/toolkits/models/openai)
