...
See [Image as input](/basics/multimodal/images/image_input) for more details.
...
- View [Image Team Examples](/examples/basics/teams/multimodal/image_to_text)
- View [Audio Team Examples](/examples/basics/teams/multimodal/audio_to_text)
- View [Video Team Examples](/examples/basics/teams/multimodal/video_caption_generation)