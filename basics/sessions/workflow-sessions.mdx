...
See the [workflow history implementation guide](/context/history/workflow/overview) for advanced controls, per-step overrides, and programmatic access patterns.
...
<CardGroup cols={2}>
  <Card title="Workflow History" icon="clock-rotate-left" href="/context/history/workflow/overview">
    Enable workflows to learn from previous runs
  </Card>
  <Card title="Session State" icon="database" href="/context/state/workflows/overview">
