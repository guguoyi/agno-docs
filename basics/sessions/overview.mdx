...
See [Session Storage](/basics/database/overview) for more details on how sessions are stored.
...
<Note>
  ...
  the agent. See [Storage](/basics/database/overview) for more details.
</Note>
