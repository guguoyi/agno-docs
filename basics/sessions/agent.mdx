...
See more examples in [Disable Storing History Messages](/examples/basics/agent/session/09_disable_storing_history_messages) and [Disable Storing Tool Messages](/examples/basics/agent/session/10_disable_storing_tool_messages).
