...
For basic filtering with dictionary format, see [Search & Retrieval](/basics/knowledge/concepts/search-and-retrieval/overview).
...
<Note>
You need a [contents database](/basics/knowledge/concepts/content-db) with your Knowledge base to use agentic filtering.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/basics/knowledge/concepts/search-and-retrieval/overview"
  >
