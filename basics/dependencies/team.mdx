...
<CardGroup cols={2}>
  ...
  <Card title="Reference Dependencies" icon="link" href="/examples/basics/teams/dependencies/reference-dependencies">
    Reference dependencies in instructions
  </Card>
  <Card title="Access Dependencies in Tool" icon="wrench" href="/examples/basics/teams/dependencies/access-dependencies-in-tool">
