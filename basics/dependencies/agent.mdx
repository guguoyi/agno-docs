...
<CardGroup cols={2}>
  ...
  icon="play"
  href="/examples/basics/agent/dependencies/add-dependencies-run">
    Pass dependencies to agent.run()
  </Card>
  <Card title="Add Dependencies to Context"
  icon="inbox"
  href="/examples/basics/agent/dependencies/add-dependencies-to-context">
    Auto-inject dependencies into messages
  </Card>
  <Card title="Access in Tools"
  icon="wrench"
  href="/examples/basics/agent/dependencies/access-dependencies-in-tool">
