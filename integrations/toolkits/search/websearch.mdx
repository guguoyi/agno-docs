...
This is the recommended toolkit for general web search functionality. For DuckDuckGo-specific usage, see [DuckDuckGoTools](/integrations/toolkits/search/duckduckgo).
