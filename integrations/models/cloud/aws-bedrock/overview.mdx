...
Set your `AWS_ACCESS_KEY`, `AWS_SECRET_KEY`, and `AWS_REGION` environment variables.
...
| `api_key`           | `Optional[str]`            | `None`                                       | The AWS Bedrock API key for authentication. Can also be set via `AWS_BEDROCK_API_KEY` environment variable.                                                              |
| `aws_access_key`    | `Optional[str]`            | `None`                                       | The AWS access key for authentication. Can also be set via `AWS_ACCESS_KEY` environment variable.                                                                        |
| `aws_secret_key`    | `Optional[str]`            | `None`                                       | The AWS secret key for authentication. Can also be set via `AWS_SECRET_KEY` environment variable.                                                                        |
