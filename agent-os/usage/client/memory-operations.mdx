...
<Steps>
  ...
  <Step title="Start an AgentOS Server">
    Make sure you have an AgentOS server running with `enable_user_memories=True` configured on an agent. See [Creating Your First OS](/agent-os/run-your-os) for setup instructions.
  </Step>
