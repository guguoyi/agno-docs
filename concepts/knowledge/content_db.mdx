...
- **[PostgreSQL](/concepts/storage/postgres)** - Recommended for production
- **[SQLite](/concepts/storage/sqlite)** - Great for development and single-user applications  
- **[MySQL](/concepts/storage/mysql)** - Enterprise-ready relational database
- **[MongoDB](/concepts/storage/mongodb)** - Document-based NoSQL option
- **[Redis](/concepts/storage/redis)** - In-memory option for high performance
- **[In-Memory](/concepts/storage/in-memory)** - Temporary storage for testing
- **Cloud Options** - [DynamoDB](/concepts/storage/dynamodb), [Firestore](/concepts/storage/firestore), [GCS](/concepts/storage/gcs)
...
<CardGroup cols={3}>
  ...
  <Card title="Database Setup" icon="wrench" href="/concepts/storage/overview">
