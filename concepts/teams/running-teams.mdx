...
- `metrics`: The metrics of the run. For more details see [Metrics](/concepts/sessions/metrics/team).
...
See more details in the [Cancelling a Run](/concepts/run-cancellation) documentation.
