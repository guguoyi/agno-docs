...
Similar to [workflow history for steps](/concepts/chat_history/workflow), the `WorkflowAgent` has access to the full history of workflow runs for the current session.
