...
<Tip>
Use [model strings](/concepts/models/model-strings) (`"provider:model_id"`) for simpler configuration. For advanced use cases requiring custom parameters like `temperature` or `max_tokens`, use the full model class syntax.
</Tip>
