...
<CardGroup cols={2}>
  <Card
    ...
    icon="plug"
    href="/execution-control/hitl/usage/external-tool-execution"
  >
  ...
  <Card
    ...
    icon="bolt"
    href="/execution-control/hitl/usage/external-tool-execution-async"
  >
  ...
  <Card
    ...
    icon="water"
    href="/execution-control/hitl/usage/external-tool-execution-stream-async"
  >
  ...
  <Card
    ...
    icon="toolbox"
    href="/execution-control/hitl/usage/external-tool-execution-toolkit"
  >
