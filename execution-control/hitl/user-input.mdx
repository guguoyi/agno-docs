...
The same `UserInputField` structure is used in [Dynamic User Input](/execution-control/hitl/dynamic-user-input), where the agent dynamically creates these fields when it needs information.
</Note>
...
<Note>
[Dynamic User Input](/execution-control/hitl/dynamic-user-input#async-support) also supports async patterns with the same methods.
</Note>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="keyboard"
    href="/execution-control/hitl/usage/user-input-required"
  >
  ...
  <Card
    ...
    icon="list-check"
    href="/execution-control/hitl/usage/user-input-required-all-fields"
  >
  ...
  <Card
    ...
    icon="bolt"
    href="/execution-control/hitl/usage/user-input-required-async"
  >
  ...
  <Card
    ...
    icon="water"
    href="/execution-control/hitl/usage/user-input-required-stream-async"
  >
