...
<CardGroup cols={2}>
  <Card title="Dependencies Overview" icon="book" href="/context/dependencies/overview">
    Learn the fundamentals of dependency injection
  </Card>
  <Card title="Reference Dependencies" icon="link" href="/context/dependencies/team/reference-dependencies">
    Reference dependencies in instructions
  </Card>
  <Card title="Access Dependencies in Tool" icon="wrench" href="/context/dependencies/team/access-dependencies-in-tool">
