...
<CardGroup cols={2}>
  ...
  icon="book"
  href="/context/dependencies/overview">
    Learn about dependencies in Agno
  </Card>
  <Card title="Add Dependencies on Run"
  icon="play"
  href="/context/dependencies/agent/add-dependencies-run">
    Pass dependencies to agent.run()
  </Card>
  <Card title="Add Dependencies to Context"
  icon="inbox"
  href="/context/dependencies/agent/add-dependencies-to-context">
    Auto-inject dependencies into messages
  </Card>
  <Card title="Access in Tools"
  icon="wrench"
  href="/context/dependencies/agent/access-dependencies-in-tool">
