...
See the [Persistent Session with History](/context/history/agent/persistent-session-history) example for a complete implementation.

Learn more in the [Context Engineering](/context/engineering/overview) documentation.
...
See the [Chat History Management](/context/history/agent/chat-history) page for a complete implementation.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="message"
    iconType="duotone"
    href="/context/history/agent/chat-history"
  >
  ...
  <Card
    ...
    icon="database"
    iconType="duotone"
    href="/context/history/agent/persistent-session-history"
  >
