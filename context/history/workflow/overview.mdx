...
<CardGroup cols={2}>
  <Card
    ...
    icon="rotate"
    iconType="duotone"
    href="/context/history/workflow/single-step-continuous-execution-workflow"
  >
  ...
  <Card
    ...
    icon="list-check"
    iconType="duotone"
    href="/context/history/workflow/workflow-with-history-enabled-for-steps"
  >
    Add workflow history to all steps in the workflow.
  </Card>
  <Card
    ...
    icon="toggle-on"
    iconType="duotone"
    href="/context/history/workflow/enable-history-for-step"
  >
  ...
  <Card
    ...
    icon="code"
    iconType="duotone"
    href="/context/history/workflow/get-history-in-function"
  >
