...
See the [Direct Response with Team History](/context/history/team/respond-directly-with-history) example for a complete implementation.
...
See the [Team History for Members](/context/history/team/team-history) example for a complete implementation.
...
See the [Share Member Interactions](/context/history/team/share-member-interactions) example for a complete implementation.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="reply"
    iconType="duotone"
    href="/context/history/team/respond-directly-with-history"
  >
  ...
  <Card
    ...
    icon="share-nodes"
    iconType="duotone"
    href="/context/history/team/team-history"
  >
  ...
  <Card
    ...
    icon="user-check"
    iconType="duotone"
    href="/context/history/team/history-of-members"
  >
  ...
  <Card
    ...
    icon="comments"
    iconType="duotone"
    href="/context/history/team/share-member-interactions"
  >
