...
| `enable_agentic_knowledge_filters` | `bool`      | `False` | If True, let the team choose the knowledge filters. See [knowledge](/basics/knowledge/concepts/filters/overview) for more information.                                       |
