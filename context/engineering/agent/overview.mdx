...
| `enable_agentic_knowledge_filters` | `bool`      | `False` | If True, let the agent choose the knowledge filters. See [knowledge](/basics/knowledge/concepts/filters/overview) for more information.                                                      |
...
Learn about agentic knowledge filters in more detail in the [knowledge filters](/basics/knowledge/concepts/filters/overview) section.
